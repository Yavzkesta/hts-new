...
title: HebergTonServ template in depth
excerpt: While easy to get started, HebergTonServ is quite complex internally.  This page provides documentation on some of the more intricate parts.
...
tags:
  ...
  - front-end
metadata:
  canonical: https://HebergTonServ.vercel.app/HebergTonServ-template-in-depth
---
...
It can be a somewhat daunting task trying to get a handle on _HebergTonServ_ internals, and particularly various points of usage.

This page outlines and clarifies some of the techniques found in _HebergTonServ_. Use it as a guide for further modification, or an instructional for techniques to use in your own endeavors.

## Styling

As the name suggests, _HebergTonServ_ relies on _TailWind_ for styling. Furthermore, _HebergTonServ_ defines custom low level style settings which are incorporated into _TailWind_ seamlessly, and which provides consistency for higher level styling constructs, as well as enabling dark mode.
...
<DListItem dt="layouts/Layout.astro">
  This layout is used for all of the pages rendered by _HebergTonServ_. The contents of _tailwind.css_ and
...
Now, we get to the techniques used in _HebergTonServ_, we'll use the _pages/index.astro_ file to illustrate.
...
<CallToAction
  callToAction={{
    text: 'Get template',
    href: 'https://github.com/onwidget/HebergTonServ',
